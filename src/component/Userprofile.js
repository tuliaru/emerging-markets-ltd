...
const Userprofile = () => {
    ...
    const submitForm = (e) => {
        ...
        if (document.getElementById("fname").value=="" || document.getElementById("mname").value=="" ||  document.getElementById("organization").value=="" || document.getElementById("compphone").value=="" || document.getElementById("email").value==""){
        ...
        <div className='input-blocks d-flex align-items-center'>
               ...
               <span className="d-inline-block me-4 align-middle"><img src={IMAGES.LoginUser} alt="Login" /></span>
                ...
                <div className='d-inline-block align-middle w-100'><label htmlFor="email" className='input-label'>Email</label>
                    <input type="text" autoComplete='off' name="email" id="email" placeholder='Email'  value={email} 
