...
const MasterOrganizationEdit = () => {
    ...
    useEffect(()=>{
		...
		axiosURL.post('/get-organization-info',{organization_id : uParam.id},
                  ...
                  'Authorization':'Bearer ' + token
                        ...
                        let uProfile = JSON.parse(localStorage.getItem('userProfile'));
                        if (uProfile.OrganizationId === uParam.id){
                           setIsSameOrg(true); 
                        }
    ...
    useEffect(() => {
        ...
        function checkedActive(e) { 
            ...
            alert(document.getElementById("isactive").value);  	  
 ...
 <div className='kcRightSection kcRightSection-reg light-body-bg shadow-lg py-4 px-4 rounded-4'>
        ...
        <div className='input-blocks d-flex align-items-center'>
            ...
            <input className="form-check-input" type="checkbox" id="isactive" name="isactive" ref={checkbox} onChange={(e) => handleCheckbox(e)} checked={checked} disabled={issameorg} />
