...
const AdminCurrencyAndCountry = () => {
    ...
    const handlePagination = (pageNo) => {
      ...
      getListsOfCountryCurrency(pageNo,country,currency,region);
           ...
           <tfoot>
            ...
            <th className="align-middle"><input type="text" placeholder="Search" className="form-control input-sm w-75 search-country" onChange ={(e) => {
              if(e.target.value.length >= 3){
                 ...
                 getListsOfCountryCurrency(1,e.target.value,document.querySelector('.search-currency').value,document.querySelector('.search-region').value)
             } else if(e.target.value.length == 0){
                 
                getListsOfCountryCurrency(1,document.querySelector('.search-country').value,document.querySelector('.search-currency').value,document.querySelector('.search-region').value);
            ...
            <th className="align-middle"><input type="text" placeholder="Search" className="form-control input-sm w-75 search-currency" onChange ={(e) => {
             if(e.target.value.length >= 3){
                getListsOfCountryCurrency(1,document.querySelector('.search-country').value,e.target.value,document.querySelector('.search-region').value)
            }else if(e.target.value.length == 0){
            ...
            <th className="align-middle"><input type="text" placeholder="Search" className="form-control input-sm w-75 search-region" onChange ={(e) => {
             if(e.target.value.length >= 3){
                getListsOfCountryCurrency(1,document.querySelector('.search-country').value,document.querySelector('.search-currency').value,e.target.value)
            }else if(e.target.value.length == 0){
